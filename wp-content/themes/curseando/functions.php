...
function twentyfifteen_scripts() {
	...
	wp_enqueue_script( 'skel', get_template_directory_uri() . '/js/skel.min.js', array( 'jquery' ), '1', true );
	wp_enqueue_script( 'util', get_template_directory_uri() . '/js/util.js', array( 'jquery' ), '1', true );
...
add_action('rest_api_init', 'slug_add_post_data', 1, 1);
...
function slug_update_field($value, $object, $field_name) {
	...
	return update_post_meta($object->ID, $field_name,$new_value,false);
}

function validate($string, $unqiue = true) {
...
add_filter( 'rest_endpoints', function( $endpoints ){
    if ( ! isset( $endpoints['/wp/v2/cursos'] ) ) {
        return $endpoints;
    }
